...
import withLoginExercise from "./withLoginExercise";

const HocExercise = () => {
    const ComponentWithLoginExercise = withPropsStyles(
        withLoginExercise(SimpleComponent)
    );
